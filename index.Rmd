...
This communication has been taking place via quantum entanglement between two science officers (F & J) on a spaceship exploring the orion arm of the milky way and a correspondent political officer (M) on their homeworld (undisclosed location 1691 lightyears away).
...
```{r, fig.fullwidth = TRUE, echo = FALSE}
knitr::include_graphics('assets/DSC_8394.jpg')
```
...
```{r, fig.fullwidth = FALSE, echo = FALSE}
knitr::include_graphics('assets/DSC_8403.jpg')
```
...
The work was exhibited during 'Nature Art Fieldworks' at the international Forest Art Center in Darmstadt, Germany.

```{r, fig.fullwidth = FALSE, echo = FALSE}
knitr::include_graphics('assets/DSC_8901.JPG')
```

```{r, fig.fullwidth = FALSE, echo = FALSE}
knitr::include_graphics('assets/DSC_8900.JPG')
```

```{r, fig.fullwidth = FALSE, echo = FALSE}
knitr::include_graphics('assets/DSC_8911.JPG')
```

```{r, fig.fullwidth = FALSE, echo = FALSE}
knitr::include_graphics('assets/DSC_8912.JPG')
```
Close-up impressions from the outdoor installation after 7 weeks of display.

```{r, fig.fullwidth = FALSE, echo = FALSE}
knitr::include_graphics('assets/DSC_8892.JPG')
```
Frame containing letter to homeworld and key specimens.
